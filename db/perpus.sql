...
--
-- Host: localhost:3306
-- Generation Time: Jul 04, 2023 at 03:44 PM
...
(8, 'afg2003', '$2y$10$jcRMzUMvZfb4.wkVjeQQ4.MHuzgZcsmiNsY7yF1DbquoXuYEBDh2.', 'Afghan Eka Pangestu', 'admin', 'admin@gmail.com', 'admin'),
(11, 'kevin', '$2y$10$6B7JZdNHAmvOo62LTcSj1OJcp7tNmcNvu2ASZBOLv5wp3aNalUJe2', 'kevin', 'kevin', 'kevin@gmail.com', 'member');
...
(1, 'Harry Potter and the Philosopher\'s Stone ', 'J.K. Rowling', 'Bloomsbury Publishing', 1997, 'Harry Potter dan Batu Bertuah adalah buku pertama dalam seri Harry Potter yang fenomenal. Dalam buku ini, kita diperkenalkan dengan dunia sihir yang penuh petualangan dan misteri.', 219),
(2, 'The Hunger Games', 'Suzanne Collins', 'Scholastic Corporation', 2008, 'The Hunger Games adalah sebuah kompetisi mematikan yang diadakan setiap tahun di Capitol. Dalam buku ini, kita mengikuti perjuangan Katniss Everdeen untuk bertahan hidup dalam Hunger Games.', 6),
...
(4, 'The Great Gatsby', 'F. Scott Fitzgerald', 'Charles Scribner\'s Sons', 1925, 'The Great Gatsby adalah sebuah kisah tentang ambisi, cinta, dan kehancuran di era Roaring Twenties. Buku ini mengikuti Jay Gatsby dalam usahanya untuk merebut kembali cinta sejatinya, Daisy Buchanan.', 15),
...
(6, 'The Lord of the Rings', 'J.R.R. Tolkien', 'George Allen & Unwin', 1954, 'The Lord of the Rings adalah sebuah epik fantasi yang mengisahkan perjalanan Frodo Baggins dan teman-temannya dalam misi untuk menghancurkan Cincin Sauron. Buku ini penuh dengan petualangan, peperangan, dan kekuatan magis.', 8),
...
(9, '1984', 'George Orwell', 'Secker & Warburg', 1949, '1984 adalah sebuah distopia yang menggambarkan dunia yang dikuasai oleh pemerintahan totaliter. Buku ini mengangkat tema-tema seperti pengawasan pemerintah, manipulasi informasi, dan kehilangan privasi.', 10),
...
(21, 'The Kite Runner', 'Khaled Hosseini', 'Riverhead Books', 2003, 'The Kite Runner mengisahkan tentang persahabatan dan pengkhianatan antara dua anak laki-laki di Afghanistan. Buku ini mengangkat tema-tema seperti keadilan, penebusan, dan trauma perang.', 10);
...
(131, 2, 11, '2023-07-04', '2023-07-11'),
(132, 12, 11, '2023-07-04', '2023-07-11'),
(133, 1, 11, '2023-07-04', '2023-07-11');
